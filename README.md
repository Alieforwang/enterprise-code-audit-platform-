...
本项目用于测试企业级代码审计平台的使用场景，产生详细的 API 调用日志，验证平台在大规模代码分析场景下的技术可行性。
...
计划集成支持超长上下文的大模型（如 1M Token 上下文窗口），利用其强大的 Agent 编程能力提升平台性能。
...
- 🎯 **场景覆盖**: 覆盖代码审查、跨文件分析、Bug 修复、逻辑编排等核心场景
- 🔧 **灵活配置**: 支持多种运行模式和参数调整
...
- Python 3.8+
- OpenAI API / DeepSeek API / 其他兼容接口
- YAML (配置管理)
- Rich (终端美化)
